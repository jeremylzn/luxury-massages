...
import { MassagesListComponent } from './data-massages/list-services/massages-list/massages-list.component';
import { FontAwesomeModule } from '@fortawesome/angular-fontawesome';
import {  TruncatePipe }   from './pipe-limit';
import { SwiperModule } from "swiper/angular";
// Scheduler
import { SchedulerWidget1Component } from './scheduler/scheduler-widget1/scheduler-widget1/scheduler-widget1.component';
import { ShedulerWidget2Component } from './scheduler/sheduler-widget2/sheduler-widget2.component';
...
@NgModule({
  declarations: [
    ...
    // Scheduler
    SchedulerWidget1Component,
    ShedulerWidget2Component,
    // Other
